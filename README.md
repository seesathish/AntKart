...
[![MassTransit](https://img.shields.io/badge/MassTransit-SAGA-FF6B35)](https://masstransit.io/)
[![RabbitMQ](https://img.shields.io/badge/RabbitMQ-3.x-FF6600?logo=rabbitmq&logoColor=white)](https://www.rabbitmq.com/)
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-EF_Core_9-336791?logo=postgresql&logoColor=white)](https://www.postgresql.org/)
[![MongoDB](https://img.shields.io/badge/MongoDB-7.x-47A248?logo=mongodb&logoColor=white)](https://www.mongodb.com/)
[![Redis](https://img.shields.io/badge/Redis-7.x-DC382D?logo=redis&logoColor=white)](https://redis.io/)
[![Keycloak](https://img.shields.io/badge/Keycloak-24.0-00B8E3?logo=keycloak&logoColor=white)](https://www.keycloak.org/)
...
[![Ocelot](https://img.shields.io/badge/API_Gateway-Ocelot_23.x-E74C3C)](https://github.com/ThreeMammals/Ocelot)
[![License: MIT](https://img.shields.io/badge/License-MIT-22C55E)](LICENSE)

AntKart is a **production-grade cloud-native e-commerce platform** built with **.NET 9 microservices**. Each service is independently deployable and follows **Clean Architecture + Domain-Driven Design**. The platform demonstrates real-world patterns: **CQRS via MediatR**, **event-driven SAGA orchestration** over RabbitMQ, **JWT authentication** via Keycloak, **Razorpay payment processing**, **Polly v8 resilience** (retry + circuit breaker), and **structured observability** through the ELK stack.
...
| Architecture | Clean Architecture + DDD per service |
| Messaging | MassTransit 8.x + RabbitMQ (SAGA + Outbox) |
| API Gateway | Ocelot 23.x (JWT passthrough, rate limiting, circuit breaker) |
| Identity | Keycloak 24 (OIDC, roles, brute-force protection) |
| Databases | PostgreSQL · MongoDB · Redis · SQLite |
| Payments | Razorpay (sandbox + production) |
| Observability | Serilog → Elasticsearch → Kibana (structured logs, correlation IDs) |
| Resilience | Polly v8 (HTTP retry, circuit breaker, Npgsql/Redis pipelines) |
| Testing | xUnit + Moq + FluentAssertions · 617+ unit + integration tests |
| Containers | Docker Compose (16 containers, health-checked startup order) |
